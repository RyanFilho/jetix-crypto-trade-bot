...
import _ from "lodash" // TODO: Get rid of lodash.
...
if (send_signal_to_bva) {
    ...
    console.log("create a socket client connection to send your signals to NBT Hub (http://bitcoinvsaltcoins.com)")
...
const binance_client = Binance.default()
...
cron.schedule('* * * * *', function() {
    ...
    console.log(startTime.toISOString().slice(0,10) + ' - EXECUTE TASK CALLED!');
    run();
    var endTime = new Date();
    var ms = (startTime.getTime() - endTime.getTime()) / 1000 % 60;
    console.log(ms + 'ms - EXECUTE TASK ENDED!');
});
